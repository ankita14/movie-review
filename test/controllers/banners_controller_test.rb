...
class BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { image: @banner.image, link: @banner.link, position: @banner.position, text: @banner.text }
    end
  ...
  test "should update banner" do
    patch :update, id: @banner, banner: { image: @banner.image, link: @banner.link, position: @banner.position, text: @banner.text }
    assert_redirected_to banner_path(assigns(:banner))
  end
