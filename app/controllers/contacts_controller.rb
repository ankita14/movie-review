class ContactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @contact.save
        flash[:success] = 'Thank you, your query has been successfully submitted. We will get back to you soon.'
  ...
  private
    ...
    def contact_params
      params.require(:contact).permit(:f_name, :l_name, :email, :message)
    end
end
